  ...
  return onAuthStateChanged(auth, async (user: User | null) => {
    ...
    if (user) {
      if (cachedAccessToken) {
        ...
        // If user is logged in to Firebase but we have no cached OAuth token in memory yet
        // (e.g. page refresh), they need to click Connect to re-acquire the in-memory token
